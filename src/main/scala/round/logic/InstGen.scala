...
object InstGen {
  ...
  //-eVars: set of existantially quantified variables
  protected def termsGeneratedBy( uVars: Set[Variable],
    ...
    def ok(f: Formula) = {
      ...
      f.freeVariables.forall( v => uVars(v) || eVars(v) ) &&
  ...
  //TODO E-matching
  //get a Matching from the cClasses
  //each clause
  //    get the ∀ vars in formula
  //    get the generated terms
  //    for each term get the matches
  //    intersect all the matches
